...
export class TaskDetailsService {
    ...
    getTasks() {
        return this.apiService.get(this.configService.getTaskUsers + '/users' + '/tasks');
    }
    getIncompleteMyTasks() {
        return this.apiService.get(this.configService.getTaskUsers+ '/users' + '/tasks?status=incomplete');
    }

    getCompleteMyTasks(){
        return this.apiService.get(this.configService.getTaskUsers+ '/users' + '/tasks?status=complete')
    }
}
